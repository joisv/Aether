                ...
                <tr>
                    <x-tables.td>
                        <input id="default-{{ $index }}" type="checkbox"
                            ...
                            wire:model.live="mySelected" value="{{ $customer->id }}">
                    </x-tables.td>
                    <x-tables.td>
                        {{ $customer->name }}
                    </x-tables.td>
                    <x-tables.td>{{ $customer->created_at->format('F j, Y') }}</x-tables.td>
                    <x-tables.td>{{ $customer->updated_at->format('F j, Y') }}</x-tables.td>
